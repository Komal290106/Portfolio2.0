    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        >
          ...
          <span className={`pixel-font text-sm font-bold tracking-wider ${
            isScrolled
              ? isDark ? 'text-purple-400' : 'text-orange-700'
            ...
            >
              ...
              <motion.div
                className={`absolute bottom-0 left-0 w-0 h-0.5 ${
                  isScrolled
                    ? isDark ? 'bg-purple-400' : 'bg-orange-600'
                    : isDark ? 'bg-purple-300' : 'bg-orange-500'
                }`}
